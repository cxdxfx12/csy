...
-- ============================================
-- 系统管理员(role_id=2) - 分配全部菜单（同超管）
-- ============================================
INSERT INTO `ds_role_menu` (`role_id`, `menu_id`)
SELECT 2, `id` FROM `ds_menu`;

-- ============================================
-- 项目经理(role_id=3) - 所有业务菜单，排除系统管理(1-6)和小区管理(8)
-- ============================================
...
-- ============================================
-- 客服主管(role_id=4) - 房产/业主/报修/投诉 + 数据概览
-- ============================================
INSERT INTO `ds_role_menu` (`role_id`, `menu_id`) VALUES
(4, 7), (4, 9), (4, 10),
(4, 11), (4, 12),
...
-- ============================================
-- 安保主管(role_id=6) - 房产/业主/安保/停车 + 数据概览
-- ============================================
INSERT INTO `ds_role_menu` (`role_id`, `menu_id`) VALUES
(6, 7), (6, 9), (6, 10),
(6, 11), (6, 12),
...
-- ============================================
-- 工程主管(role_id=7) - 房产/业主/设备/供应商 + 数据概览
-- ============================================
INSERT INTO `ds_role_menu` (`role_id`, `menu_id`) VALUES
(7, 7), (7, 9), (7, 10),
(7, 11), (7, 12),
