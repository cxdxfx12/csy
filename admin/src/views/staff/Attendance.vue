...
const query = reactive({ keyword: '', date_start: '', date_end: '', type: undefined as any, page: 1, limit: 15 })
...
function resetQuery() { Object.assign(query, { keyword: '', date_start: '', date_end: '', type: undefined, page: 1 }); loadData() }
