<template>
  <div class="page">
    ...
    <div class="user-card" v-if="profile">
      ...
      <div>
        <strong>{{ profile.realname || profile.name || '业主' }}</strong>
    ...
    <div class="grid">
      ...
      <router-link to="/bill" class="card"><span>💰</span><label>物业账单</label></router-link>
      <router-link to="/repair" class="card"><span>🔧</span><label>报事报修</label></router-link>
      <router-link to="/complaint" class="card"><span>📝</span><label>投诉建议</label></router-link>
      <router-link to="/notice" class="card"><span>📢</span><label>社区公告</label></router-link>
